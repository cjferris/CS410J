...
public class Project3Test extends InvokeMainTestCase {
  ...
  public void test1NoCommandLineArguments() {
	...
	public void test3CallerPhoneNumberContainsNonIntegers() {
		MainMethodResult result = invokeMain(Project3.class, "Test3", "ABC-456-7890", "234-567-8901", "03/03/2015", "12:00", "05/04/2015", "16:00");
		assertEquals(new Integer(-1), result.getExitCode());
	...
	public void test4StartTimeMalformed() {
		MainMethodResult result = invokeMain(Project3.class, "Test4", "123-456-7890", "234-567-8901", "03/03/2015", "12:XX", "05/04/2015", "16:00");
		assertEquals(new Integer(-1), result.getExitCode());
	...
	public void test5EndTimeMalformed() {
		MainMethodResult result = invokeMain(Project3.class, "Test5", "123-456-7890", "234-567-8901", "03/03/2015", "12:00", "05/04/1", "16:00");
		assertEquals(new Integer(-1), result.getExitCode());
	...
	public void test6UnknownCommandLineOption() {
		MainMethodResult result = invokeMain(Project3.class, "-fred", "Test6", "123-456-7890", "234-567-8901", "03/03/2015", "12:00", "05/04/2015", "16:00");
		assertEquals(new Integer(-1), result.getExitCode());
	...
	public void test7UnknownCommandLineArgument() {
		MainMethodResult result = invokeMain(Project3.class, "Test6", "123-456-7890", "234-567-8901", "03/03/2015", "12:00", "05/04/2015", "16:00", "fred");
		assertEquals(new Integer(-1), result.getExitCode());
		assertTrue(result.getErr().contains("Error: Unknown command line arguments"));
	}
	...
	public void test8Print() {
		MainMethodResult result = invokeMain(Project3.class, "-print", "Test8", "123-456-7890", "234-567-8901", "03/03/2015", "12:00", "05/04/2015", "16:00");
		assertEquals(new Integer(1), result.getExitCode());
	...
	public void test9MultiWordNamePrint() {
		MainMethodResult result = invokeMain(Project3.class, "-print", "Test 9", "123-456-7890", "234-567-8901", "03/03/2015", "12:00", "05/04/2015", "16:00");
		assertEquals(new Integer(1), result.getExitCode());
	...
	public void test10NoEndDateOrTime() {
		MainMethodResult result = invokeMain(Project3.class, "Test10", "123-456-7890", "234-567-8901", "03/03/2015", "12:00");
		assertEquals(new Integer(-1), result.getExitCode());
		assertTrue(result.getErr().contains( "Missing command line arguments" ));
	}
